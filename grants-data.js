...
const GRANTS = [
  ...
  },
  {
    ...
    levelGroup: "State",
    summary:
      "The core Urban & Community Forestry Program is a long-standing, annually-appropriated USDA Forest Service program (predates the Bipartisan Infrastructure Law) funding public tree canopy, urban forest management planning, and tree inventory/assessment work — typically 50/50 matching grants. A separate, BIL/IRA-funded add-on track (UCF-PPIC, 'Plantings, Preservation, and Invasives Control') specifically funds removing invasive plant species (e.g., Australian pine, Brazilian pepper) and replacing them with native trees, with the match requirement waived — confirmed open to municipalities, not just forest-agency applicants.",
    eligibility: "Local governments, educational institutions, tribal governments, and legally organized nonprofit volunteer organizations — UCF-PPIC explicitly names municipalities as eligible.",
    fundingRange: "Varies by category; the base program is typically a 50/50 match, some grants up to $50,000. UCF-PPIC funds full project cost (no match).",
    match: "Typically 50/50 on the base program; waived on the UCF-PPIC invasive-removal/replanting track",
    cycle: "Annual, via grants.fdacs.gov",
    nextDeadlineDate: "2027-03-07",
    isEstimate: true,
    deadlineNote:
      "The FY2026 cycle had pre-proposals due Mar 7, 2026 and full proposals due Mar 11, 2026 (both already closed) — the estimated date above projects that same early-March pattern forward one year. Caveat: FDACS runs multiple, separately-scheduled forestry grant programs (e.g., the unrelated Florida's Future Forests carbon-sequestration program has its own March deadline) — confirm on grants.fdacs.gov that you're tracking the Urban & Community Forestry / UCF-PPIC solicitation specifically, not a similarly-timed but different program.",
    status: "contact_agency",
    tags: { wq: 2, canal: 1, habitat: 2, boating: 0, resilience: 2 },
    ...
    whyFit:
      "Directly fits removing Australian pine (a documented Category I invasive along Florida canal banks and shorelines) and replanting with native canopy trees — cities are explicitly eligible and the match is waived on this track. Caveat: this program's 'native trees' scope is aimed at upland urban canopy species; mangrove specifically is a coastal wetland species and was NOT confirmed as an eligible replant species here — for a mangrove-planting component paired with pine removal, pair this program with NFWF's National Coastal Resilience Fund or USFWS's Coastal Program elsewhere on this list, both of which are unambiguously built for coastal/wetland habitat restoration.",
